...
module.exports = class command extends Command {
  ...
  execute = async (M, {context}) => {
    ...
    if (!context) return void M.reply(
        'Provide the Emoji you want as sticker, Baka!')

    try {
      const b = await this.helper.utils.getBuffer(
          `https://emojiapi.dev/api/v1/${hex}/512.webp`)
